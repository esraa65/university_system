...
import 'package:university_system/viewmodel/termsandcondition/termsandcondition_cubit.dart';

class TermsAndCondition extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TermsandconditionCubit()..GetTermsData(),
      child: BlocConsumer<TermsandconditionCubit, TermsandconditionState>(
        listener: (context, state) {
          // TODO: implement listener
        },
        builder: (context, state) {
          TermsandconditionCubit Mytermscubit =
              TermsandconditionCubit.get(context);
          return Scaffold(
              appBar: AppBar(
                leading: BackButton(
                  color: Colors.black,
              ...
              body: Container(
                  ...
                  Padding(
                      ...
                      child: Mytermscubit.termsmodel == null
                          ? Center(
                          ...
                          : SingleChildScrollView(
                            child: RichText(
                                ...
                                text: HTML.toTextSpan(
                                    context, Mytermscubit.htmlContent!,defaultTextStyle: TextStyle(
